...
urlpatterns = [
    ...
    url(r'^actualizar_laboratorios/(?P<pk>\d+)/$', ActualizarView.as_view(),
        name="actualizar_laboratorios"),
    url(r'^eliminar_laboratorios/(?P<pk>\d+)/$', EliminarView.as_view(),
        name="eliminar_laboratorios"),
